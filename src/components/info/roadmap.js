 ...
 BV Dating Club is essentially a blockchain-based social dating community that offers key elements missing from current dating app, like trust, transparency, data security and fraud protection against nefarious actors, or ‘catfishes.
        ...
        <s.Container
          ...
          <s.TextTitle
            ...
            >
 Christina, the wife, the Tech Lead of the project, a experienced full stack developer, and is in love with blockchain in recent years. She loves drawing, meditating & reading in her spare time.             
           </s.TextTitle>            
            </s.TextTitle>  
        </s.Container>  
        <s.SpacerXSmall/>
        <s.Container
          ...
          <s.TextTitle
            ...
            >
Jack, the husband, and the Project Manager of Bored Valentines Club, has over 10 years of experience in game development and project management.          </s.TextTitle>            
            </s.TextTitle>  
        </s.Container> 
        <s.SpacerXSmall/>          
        <s.Container
